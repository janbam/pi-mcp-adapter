...
// FORK-OWNED: neutralize the fork's PI_MCP_TIMEOUT env knob so assertions on
// exact RequestOptions shapes stay valid regardless of the host environment.
beforeEach(() => {
  delete process.env.PI_MCP_TIMEOUT;
});
